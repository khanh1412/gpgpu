...
class Queue: public Singleton
{
	...
	public:
		...
		Event& enqueueNDRangeKernel(const Kernel& kernel, const Container<Buffer>& parameters, Array<size_t> global_dim, Array<size_t> local_dim);
